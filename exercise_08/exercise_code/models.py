...
class Decoder(nn.Module):
    ...
    def __init__(self, hparams, latent_dim=20, output_size=28 * 28):
        ...
        self.decoder = nn.Sequential(
            nn.Linear(latent_dim, hparams["n_hidden"]),
            nn.ReLU(),
...
class Autoencoder(nn.Module):
    ...
    def set_optimizer(self):
        ...
        self.optimizer = Adam(chain(self.encoder.parameters(), self.decoder.parameters()), self.hparams["learning_rate"])
    ...
    def training_step(self, batch, loss_func):
        ...
        loss_current = loss_func(pred, images)
...
class Classifier(nn.Module):
    ...
    def __init__(self, hparams, encoder):
        ...
        self.model = nn.Sequential(
            nn.Linear(encoder.latent_dim, hparams["num_classes"])
        )
        self.device = hparams.get("device", torch.device("cuda" if torch.cuda.is_available() else "cpu"))
    ...
    def set_optimizer(self):
        ...
        self.optimizer = Adam(chain(self.model.parameters(), self.encoder.parameters()), self.hparams["learning_rate"])
        ########################################################################
